...
test("rejects invalid transitions",()=>{for(const [from,to] of [["draft","published"],["submitted","published"],["rejected","reviewing"],["published","approved"]])assert.throws(()=>assertTransition(from,to));});
