...
export async function getSession() {
  // This only decides which client-side workspace to display. Every protected
  // API request is still verified by the server, so avoid getUser() here: it
  // always adds a network request to the Auth region.
